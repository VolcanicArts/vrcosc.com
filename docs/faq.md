...
`runtime.log` is the main log file
...
1. Running the setup exe as admin
2. Reinstall [.NET10](https://dotnet.microsoft.com/en-us/download/dotnet/10.0) and re-running the setup exe
3. Ensuring you're not using OneDrive as your desktop
4. Disable any third-party anti-viruses and re-running the setup exe
5. Deleting `%appdata%/VRCOSC` and re-running the setup exe
6. Deleting `%localappdata%/VRCOSC` and re-running the setup exe
7. Re-download the setup exe with Chrome
